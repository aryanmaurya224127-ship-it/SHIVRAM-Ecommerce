              ...
              <div className="col-12 col-sm-6 col-md-4 col-lg-3" key={item.id}>
                ...
                <div className="card h-100 shadow-sm">
                  ...
                  <div className="text-center p-3">
                    <img src={item.image}alt={item.CardTitle} style={{ width: '200px',height: '200px',objectFit: 'cover'}}/>
                  </div>
                  ...
                  <div className="card-footer bg-white border-0">
                    ...
                    <button className="btn btn-danger w-100 mb-2"onClick={() => removeFromCart(item.id)}>
                      Remove from Cart
                    </button>
